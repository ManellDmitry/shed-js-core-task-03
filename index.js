...
export default { createObject, getImputValues, getNames, createTemplateObject };
...
delete user["age"];
// console.log(user["age"]); undefined property is deleted
...
const users = JSON.parse(localStorage.getItem("users")); //Достанем из хранилища созданые формой обьёкты
...
moviesList.showMovies(); //вызываем метод обьекта!

// == метод можно добавить, как обычное свойство
productsList.showProducts = function () {
    console.log("array products", this.productsList);
    console.log("product", ...this.productsList);
};
console.log(productsList);
productsList.showProducts(); // we call the object method
...
moviesList.mapMovies(); //we call the object method

// == метод можно удалить, также, как и обычное свойство, через delete

//100 переменных
let user = "Dima";
let userFullName = "Manell Dima";
const userPhone = 05555 5656 565;
const checkPassword = "dimoncool";
const passwordToConfirm = "dimoncooll";
const value = "true";
